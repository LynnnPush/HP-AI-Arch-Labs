...
def tvb76_weights_lengths() -> tuple[np.ndarray, np.ndarray]:
    import zipfile
...
def tvb192_weights_lengths() -> tuple[np.ndarray, np.ndarray]:
    import zipfile
    import urllib.request
...
def tvb998_weights_lengths() -> tuple[np.ndarray, np.ndarray]:
    import zipfile
    import urllib.request
